...
- İş puanını workflow executor model profilini ve çalışma kapsamını belirlemek için kullan.
...
Proje, görev başlığı, kısa açıklama, 2/3/5 iş puanı, durum, bağımlılıklar ve tamamlanma ölçütü içeren yapılandırılmış sonuç üret.
